...
int main(){
	...
	head = NULL;
	insertfirst(1,"Apple     ",20,120.20);
	insertend(2,"Banana    ",60,100.60);
	insertend(3,"Oranges   ",80,100.80);
	insertend(4,"Pears     ",30,70.30);
	insertend(5,"Avocoado  ",40,70.40);
	insertend(6,"Star Fruit",40,60.40);
	insertend(7,"Dragon Frt",40,520.40);
	insertend(8,"Grapes    ",50,35.50);
	insertend(9,"Mango(Alp)",12,20.12);
	...
	if(get_food_choice == temp->data){
		...
		if(confirm == 1 ){
			...
			if(payment==1){
				...
				br(2);pre(4);  printf("1. Order Another Item ");
			...
			///Credit Card Option
				...
				br(2);pre(2);  printf("Enter Your Card Pin Number  : ");
...
void main_menu(){
	...
	cls();
	br(5); pre(3); echo(">> 1. Fruits List"); Sleep(400);
...
void pwellcome(){
	...
	char welcome2[50]=" TO";
	char welcome3[50]=" FRUIT SHOP";
	char welcome4[150]=" MANAGEMENT SYSTEM";
	char welcome5[50]="By";
	char welcome6[10]="FYCM1";
	printf("\n\n\n\n\n\t\t\t");
